...
**Source:** [#4260](https://github.com/TheRocketCodeMX/gsd-core/issues/4260)
...
- [PR #4251](https://github.com/TheRocketCodeMX/gsd-core/pull/4251) — fix(#4250): distinguish a timed-out npm audit from a JSON parse failure; the redirect target
- [#4250](https://github.com/TheRocketCodeMX/gsd-core/issues/4250) — the diagnosis issue #4251 fixes
