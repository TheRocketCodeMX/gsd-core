...
|------|-----------|---------------|---------|--------|---------|
| **Patch** | Bug fixes only | `1.27.1` | `latest` | `hotfix/1.27.1` | `npx @therocketcode/gsd-core@latest` |
| **Minor** | Fixes + enhancements | `1.28.0` | `latest` (after RC) | `release/1.28.0` | `npx @therocketcode/gsd-core@next` (RC) |
| **Major** | Fixes + enhancements + features | `2.0.0` | `latest` (after beta) | `release/2.0.0` | `npx @therocketcode/gsd-core@next` (beta) |
...
|-----|---------|-------------|
| `latest` | Stable production release | `npm install @therocketcode/gsd-core` (default) |
| `next` | Pre-release (RC or beta) | `npm install @therocketcode/gsd-core@next` (opt-in) |
...
4. Test the RC: `npx @therocketcode/gsd-core@next`
...
npm dist-tag ls @therocketcode/gsd-core
```
