...
无更新时横幅保持静默，"检查失败"诊断每 24 小时限流一次。通过 `npx @therocketcode/gsd-core --uninstall` 或删除引用 `gsd-update-banner.js` 的 SessionStart 条目可干净移除。
...
**参考 issue：** [#2790](https://github.com/TheRocketCodeMX/gsd-core/issues/2790)
...
**参考 issue：** [#2792](https://github.com/TheRocketCodeMX/gsd-core/issues/2792)
...
**参考 issue：** [#2833](https://github.com/TheRocketCodeMX/gsd-core/issues/2833) — 完整字段参考和渲染规则见 [`docs/STATE-MD-LIFECYCLE.md`](reference/state-md.md)。
...
**参考 issue：** [#3023](https://github.com/TheRocketCodeMX/gsd-core/pull/3030)
...
**参考 issue：** [#3024](https://github.com/TheRocketCodeMX/gsd-core/pull/3031)
...
- 无更新时保持静默。
- 失败诊断每 24 小时限流一次。
- 通过 `npx @therocketcode/gsd-core --uninstall` 干净移除。
...
**参考 issue：** [#2795](https://github.com/TheRocketCodeMX/gsd-core/pull/2795)
...
**参考 issue：** [#2840](https://github.com/TheRocketCodeMX/gsd-core/pull/2840)
...
**参考 issue：** [#3170](https://github.com/TheRocketCodeMX/gsd-core/issues/3170)
