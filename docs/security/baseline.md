...
beginning with the pilot repo `TheRocketCodeMX/gsd-core`.
...
(`TheRocketCodeMX/gsd-core`). Sibling repos adopt the same controls during
Phase 2 rollout (§ 6).
...
[#135](https://github.com/TheRocketCodeMX/gsd-core/pull/135)
(linked to issue
[#114](https://github.com/TheRocketCodeMX/gsd-core/issues/114)).
...
**Implementation in pilot:** PR
[#134](https://github.com/TheRocketCodeMX/gsd-core/pull/134)
(linked to issue
[#115](https://github.com/TheRocketCodeMX/gsd-core/issues/115)).
...
**Implementation in pilot:** PR
[#133](https://github.com/TheRocketCodeMX/gsd-core/pull/133)
(linked to issue
[#113](https://github.com/TheRocketCodeMX/gsd-core/issues/113)).
...
**Implementation in pilot:** PR
[#132](https://github.com/TheRocketCodeMX/gsd-core/pull/132)
(linked to issue
[#116](https://github.com/TheRocketCodeMX/gsd-core/issues/116)).
...
[#117](https://github.com/TheRocketCodeMX/gsd-core/issues/117)
(see PR #136).
...
`https://github.com/TheRocketCodeMX/gsd-core/security/advisories/new`
...
Affected repo: TheRocketCodeMX/gsd-core (or sibling repo name)
...
| Step | Detail |
|---|---|
| 1 | Requester opens a GitHub issue in `TheRocketCodeMX/gsd-core` tagged `security-exception` |
...
### Phase 1 — Pilot: `TheRocketCodeMX/gsd-core` (in progress)
