...
- `gsd-core/workflows/autonomous/steps/stopped-banner.md` (stop-banner extracted from autonomous.md — #2196 char limit)
...
| `tests/lint-allow-test-rule-refs.test.cjs` | fidelity | anchors-only | v1.11.0 realignment: repo-baseline child timeout 30s→90s — the scan measures 28s idle on the fork reference machine post-merge (283 marker files), zero headroom; environmental, ratchet back if upstream speeds the scan |
