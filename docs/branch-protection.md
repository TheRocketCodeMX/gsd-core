...
REPO=TheRocketCodeMX/gsd-core ENFORCEMENT=evaluate bash scripts/sync-rulesets.sh

# Activate protection
REPO=TheRocketCodeMX/gsd-core ENFORCEMENT=active bash scripts/sync-rulesets.sh

# Roll back to disabled
REPO=TheRocketCodeMX/gsd-core ENFORCEMENT=disabled bash scripts/sync-rulesets.sh
```
