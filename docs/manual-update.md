...
Use this procedure when `npx @therocketcode/gsd-core@latest` is unavailable — e.g. during a publish outage or if you are working directly from the source repo.

## Prerequisites

- Node.js installed
- This repo cloned locally (`git clone https://github.com/TheRocketCodeMX/gsd-core`)
