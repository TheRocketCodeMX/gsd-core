...
> repo's own `scripts/**` tooling requires. Before [#3904](https://github.com/TheRocketCodeMX/gsd-core/issues/3904)
...
brace-matching; a further AST re-measure for [#3912](https://github.com/TheRocketCodeMX/gsd-core/issues/3912)
