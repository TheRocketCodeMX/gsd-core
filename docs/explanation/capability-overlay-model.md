...
So, per the maintainer decision on [#2009](https://github.com/TheRocketCodeMX/gsd-core/issues/2009),
...
- Skipping **fails open** for steps and contributions (a missing optional addition) and,
  per [#2009](https://github.com/TheRocketCodeMX/gsd-core/issues/2009), **fails open** for gates
