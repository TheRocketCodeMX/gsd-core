...
| **Status** | Proposed |
| **Date** | 2026-08-27 |
| **Issue** | [#3942](https://github.com/TheRocketCodeMX/gsd-core/issues/3942) |
...
> **Evidence note.** Line citations below were read from the worktree at `origin/next` `11cdc19e3`. CI verdicts are from the live GitHub API for [PR #3927](https://github.com/TheRocketCodeMX/gsd-core/pull/3927), not from re-derivation. The full root-cause trace is `docs/research/3875-ack-sweep-automation-failure.md`.
...
[PR #3927](https://github.com/TheRocketCodeMX/gsd-core/pull/3927), the sweeper's first production run, was merged by hand at 12:16Z — 2h38m after opening — **with `validate-title` and `Required tests` still red**. Three independent, deterministic defects, none of them flaky:
...
- [PR #3927](https://github.com/TheRocketCodeMX/gsd-core/pull/3927) — the sweeper's first production run
