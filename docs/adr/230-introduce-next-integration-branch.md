...
`next` (`gh api repos/TheRocketCodeMX/gsd-core --jq .default_branch`), `.github/workflows/auto-backmerge.yml`
...
branch protection (verified via `gh api repos/TheRocketCodeMX/gsd-core/branches/main/protection`
...
```
gh api repos/TheRocketCodeMX/gsd-core/branches/main/protection/required_pull_request_reviews --jq .required_approving_review_count   # expect 2
gh api repos/TheRocketCodeMX/gsd-core/branches/main/protection/required_status_checks                                                # expect 200, not 404
gh api repos/TheRocketCodeMX/gsd-core/branches/main/protection --jq .allow_force_pushes.enabled                                      # expect false
```
