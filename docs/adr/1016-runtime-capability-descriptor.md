...
- **Status:** Accepted
- **Date:** 2026-06-10
- **Issue:** [#1016](https://github.com/TheRocketCodeMX/gsd-core/issues/1016)
- **Epic:** [#857](https://github.com/TheRocketCodeMX/gsd-core/issues/857) (Capability system) — rollout phase 5
...
- **Amended by:** [#2801](https://github.com/TheRocketCodeMX/gsd-core/issues/2801) (closes `hostBehaviors`) — the one hole in this ADR's closure is closed; see the amendment below.
