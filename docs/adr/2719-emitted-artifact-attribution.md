...
- **Status:** Accepted
- **Date:** 2026-07-27
- **Issue:** [#2719](https://github.com/TheRocketCodeMX/gsd-core/issues/2719) (epic); Phase 0 tracked by [#2720](https://github.com/TheRocketCodeMX/gsd-core/issues/2720)
...
- **Phase 0 — this ADR** ([#2720](https://github.com/TheRocketCodeMX/gsd-core/issues/2720), docs-only).
- **Phase 1 — interim relief** ([#2721](https://github.com/TheRocketCodeMX/gsd-core/issues/2721)). `merge=gsd-regen` driver, `npm run regen:derived`, and naming: `RULESET.EMITTED_ATTRIBUTION=` under `## Test rules and lint` plus `### Emitted Artifact Provenance` in the glossary. Touches no fixtures, so it breaks none of the 16 exposed PRs.
- **Phase 2 — provenance table + totality guard** ([#2722](https://github.com/TheRocketCodeMX/gsd-core/issues/2722)).
- **Phase 3 — differential check, dual-run** ([#2723](https://github.com/TheRocketCodeMX/gsd-core/issues/2723)). Runs beside `golden-install-parity.test.cjs`, both green, fixtures untouched.
- **Phase 4 — cutover** ([#2724](https://github.com/TheRocketCodeMX/gsd-core/issues/2724)). Delete the fixtures, generators and bridge driver; flip this ADR to `Accepted`.
