...
- **Status:** Proposed
- **Issue:** [#959](https://github.com/TheRocketCodeMX/gsd-core/issues/959)
- **Epic:** [#857](https://github.com/TheRocketCodeMX/gsd-core/issues/857) (Capability system) — rollout phase 4d
