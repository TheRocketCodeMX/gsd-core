...
- **Issue:** [#1703](https://github.com/TheRocketCodeMX/gsd-core/issues/1703) — Phase 0 of epic [#1702](https://github.com/TheRocketCodeMX/gsd-core/issues/1702)
...
- **Phase 6 scope — `require-fs-op-fallback` narrowed to rename.** The catalog row named
  ...
  Documented on [#1740](https://github.com/TheRocketCodeMX/gsd-core/issues/1740).
