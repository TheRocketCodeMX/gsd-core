...
- **Status:** Accepted
- **Date:** 2026-06-17
- **Issue:** [#1372](https://github.com/TheRocketCodeMX/gsd-core/issues/1372) (epic)
- **Resolves (via tier T1):** [#1364](https://github.com/TheRocketCodeMX/gsd-core/issues/1364), [#1365](https://github.com/TheRocketCodeMX/gsd-core/issues/1365)
- **Relates:** [#1343](https://github.com/TheRocketCodeMX/gsd-core/issues/1343), [#1324](https://github.com/TheRocketCodeMX/gsd-core/issues/1324), [#447](https://github.com/TheRocketCodeMX/gsd-core/issues/447) — prior single-parser markdown bugs
- **Pattern precedent:** [ADR-857](857-capability-system.md) / epic [#1267](https://github.com/TheRocketCodeMX/gsd-core/issues/1267) (retire a duplicated spine via tiered children)
