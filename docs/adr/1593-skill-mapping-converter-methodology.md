...
- **Status:** Accepted
- **Date:** 2026-06-22
- **Issue:** [#1593](https://github.com/TheRocketCodeMX/gsd-core/issues/1593)
- **Epic:** [#1258](https://github.com/TheRocketCodeMX/gsd-core/issues/1258) (Phase A — *"do first"*)
...
- **Epic [#1258](https://github.com/TheRocketCodeMX/gsd-core/issues/1258)** — this is Phase A. Phase B-consume (PR #1261, merged) is the reference implementation canonized in Decision 5. Phases B-provide, C (C1–C6), D are tracked as separate issues per the epic's governance.
