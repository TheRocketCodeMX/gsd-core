...
- **Status:** Proposed
- **Date:** 2026-06-12
- **Issue:** [#1143](https://github.com/TheRocketCodeMX/gsd-core/issues/1143)
...
- **Blocked by:** [#857](https://github.com/TheRocketCodeMX/gsd-core/issues/857) being **released** (Proposed → Accepted + capability infrastructure shipped). Not actionable until then.
- **Relates to:** [#853](https://github.com/TheRocketCodeMX/gsd-core/issues/853) (Claude Code backgrounded agents cannot nest subagents), existing BETA skill `gsd-ultraplan-phase`
