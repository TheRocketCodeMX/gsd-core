...
**Status:** research note — grounded in the repo's own source, workflow YAML, ADRs, and live `gh`/GitHub API data for [PR #3927](https://github.com/TheRocketCodeMX/gsd-core/pull/3927), pulled 2026-08-27.
