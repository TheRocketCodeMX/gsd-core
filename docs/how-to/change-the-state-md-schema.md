...
`active_phase`, `next_action` and `next_phases` are real frontmatter keys ([#2833](https://github.com/TheRocketCodeMX/gsd-core/issues/2833))
...
section that matters for [#3853](https://github.com/TheRocketCodeMX/gsd-core/issues/3853).
