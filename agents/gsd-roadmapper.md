...
User can review actual files in the editor or via SDK queries (e.g. `gsd_run query roadmap.analyze` and `gsd_run query state.load`) instead of ad-hoc shell `cat`.
