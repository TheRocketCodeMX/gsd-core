...
const KNOWN_SKILLS = new Set([
  ...
  'workspace.md',
  'workstreams.md',
  // ── FORK skills (TheRocketCode) ────────────────────────────────────────
  // Ported from the fork's tests/enh-2790-skill-consolidation.test.cjs when
  // upstream consolidated that file into this suite (#1975). These are the
  // fork's additive capability surface (learn/strategy/grounding + the
  // discovery & strategy-chain skills); they exist on disk in commands/gsd/
  // and must be allowlisted or the surface-budget ratchet fails closed.
  'learn.md',
  'context.md',
  'discover-product.md',
  'model-domain.md',
