 ...
 * FORK: gsd-planner is XL-tier there (upstream's own v1.9.0 planner body left 36
 * chars of LARGE headroom — no fork block fits under 49152; see docs/FORK-DELTA.md).
 * This mirrors XL_CAP; ratchet back to 49152 if upstream shrinks. */
const LARGE_CAP = 57344;
