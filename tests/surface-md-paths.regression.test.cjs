 ...
 * (`npm i -g gsd-core` instead of `@therocketcode/gsd-core`).
 *
...
describe('#2116 regression: surface.md resolvable require + correct package', () => {
  ...
  test('reinstall hint uses scoped package name', () => {
    assert.ok(
      content.includes('@therocketcode/gsd-core'),
      'surface.md reinstall hint should reference @therocketcode/gsd-core, not bare gsd-core (#2116)'
    );
  });
