...
/**
 * Regression tests for issue #6 (TheRocketCodeMX/gsd-core):
...
/**
 * Regression tests for issue #416 (TheRocketCodeMX/gsd-core).
 *
...
/**
 * Regression tests for issue #26 (TheRocketCodeMX/gsd-core).
 ...
 *
 * References:
 *   - Issue #26 (TheRocketCodeMX/gsd-core) — three drift items + reproducer
 *   - ADR-3524 (docs/adr/3524-cjs-sdk-hard-seam.md)
