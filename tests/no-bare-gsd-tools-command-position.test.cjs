...
const PROSE_ALLOWLIST = [
  // FORK: the three former agents/ entries (gsd-executor 791, gsd-phase-researcher 33,
  // gsd-roadmapper 624) are gone — the fork normalized those descriptive mentions to
  // `gsd_run` outright (#2751 contract adopted), which is sturdier than line-pinned
  // exemptions across a merge.
