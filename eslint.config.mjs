...
export default tseslint.config(
  // ── Global ignores ─────────────────────────────────────────────────────────
  {
    ignores: [
      ...
      // Rocket fork (grounding/learn/project capabilities): tsc-generated runtime artifacts.
      'gsd-core/bin/lib/grounding.cjs',
      'gsd-core/bin/lib/grounding-command-router.cjs',
      'gsd-core/bin/lib/learn.cjs',
      'gsd-core/bin/lib/learn-command-router.cjs',
