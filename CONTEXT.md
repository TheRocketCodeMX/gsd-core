...
`RULESET.CODERABBIT.GUARD.OPEN_PRS=gh pr list --repo TheRocketCodeMX/gsd-core --author @me --state open; repeat near end because open PR set can change mid-run`
...
`RELEASE-NOTES.STANDARD.footer.hotfix=Install/upgrade: \`npx @therocketcode/gsd-core@latest\``
`RELEASE-NOTES.STANDARD.footer.rc=Install for testing: \`npx @therocketcode/gsd-core@next\` (per branch->dist-tag policy)`
`RELEASE-NOTES.STANDARD.footer.full-changelog=**Full Changelog**: https://github.com/TheRocketCodeMX/gsd-core/compare/<prev>...<this>`
...
`RELEASE-NOTES.EXAMPLE.hotfix=v1.41.1 (https://github.com/TheRocketCodeMX/gsd-core/releases/tag/v1.41.1) - 14 fixes grouped by 6 subgroups`
`RELEASE-NOTES.EXAMPLE.rc=v1.42.0-rc1 (https://github.com/TheRocketCodeMX/gsd-core/releases/tag/v1.42.0-rc1) - intro + Added/Changed/Fixed/Documentation taxonomy`
...
`DEFECT.GSD-TEST-CONCURRENT-OUTPUT-COLLISION.upstream=TheRocketCodeMX/gsd-core#3545`
...
Full detail in `~/.claude/skills/gsd-pr-fix-discipline/SKILL.md`. AI agents MUST check this section before pushing to `TheRocketCodeMX/gsd-core`.
...
- **Fix:** `gh workflow run Tests --repo TheRocketCodeMX/gsd-core --ref <branch>`; verify with `gh run list --branch <branch> --workflow Tests --limit 1 --json status,conclusion,headSha`
...
- **Fix:** Merge manually by hand in dependency order once CI greens; `gh pr merge <N> --squash --repo TheRocketCodeMX/gsd-core`
