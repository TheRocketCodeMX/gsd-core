...
const GSD_HOOK_LIB_FILES = ['git-cmd.js', 'gsd-graphify-rebuild.sh', 'cursor-workspace.js', 'isolation-sentinel.js', 'injection-patterns.js'];
...
function configureOpencodePermissions(isGlobal = true, configDir = null) {
  ...
  // `-p @therocketcode/gsd-core` resolves the `gsd-mcp-server` bin from this package
